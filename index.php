						                ...
						                <div id="loginBox">                
						                    <form id="loginForm" ACTION="login.php" method="POST">
						                        <fieldset id="body">
						                            ...
						                            <label for="checkbox"><input type="checkbox" id="checkbox" name="rememberme"> <i>Remember me</i></label>
						                        </fieldset>
	 		 ...
	 		 <div class="content_top">  
	 		     <div class="wrap">                                  		
            	   <div class="banner_desc">
            		...
            		<div class="sign_up">				  	
					 <form ACTION="daftar2.php" METHOD='POST' NAME='requ'>
					  		<input name="emailn" type="text" value="E-mail address " onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'E-mail address';}"> 
					 		<input type="submit" value="Daftar" name="requ">
					  </form>
				    </div>
                </div>  
                     <div class="ipad">
